...
const copy = {
  en: {
    ...
    email: "Email address", send: "Email me an 8-digit code", sending: "Sending…", codeTitle: "Enter your sign-in code",
    codeIntro: "Enter the 8-digit code from the newest Personal Besties email. No link needs to be opened.", code: "8-digit code",
  ...
  de: {
    ...
    email: "E-Mail-Adresse", send: "8-stelligen Code senden", sending: "Wird gesendet…", codeTitle: "Anmeldecode eingeben",
    codeIntro: "Gib den 8-stelligen Code aus der neuesten Personal-Besties-E-Mail ein. Du musst keinen Link öffnen.", code: "8-stelliger Code",

...
export default function AuthScreen({ config }: { config: { url: string; publishableKey: string } | null }) {
  ...
  return <main className="auth-page">
    <section className="auth-story"><div className="brand auth-brand"><span className="brand-mark">PB</span><span>Personal Besties</span></div><div><p className="eyebrow">BETTER TOGETHER.</p><h1>Train with context.<br />Improve with friends.</h1><p>Private coaching, lactate testing, recovery signals and thoughtful plans—shared with the people helping you get better.</p></div><div className="auth-proof"><span>Invite only</span><span>Passwordless</span><span>Coach reviewed</span></div></section>
